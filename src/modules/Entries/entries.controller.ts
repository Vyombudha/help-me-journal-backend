...
import { newEntryInput, UpdateEntryInput, EntryIdParam, } from "./entries.schema.js";
...
const newEntry = async (
    ...
    const newEntry = await EntryService.new(userId, containerId, body.title, body.content)
    res.status(200).json({
        success: true,
        data: newEntry
    });
